"""Engine v9: qwen3.5:4b (no thinking) — test a different model.

qwen3.5:4b has 256K context, should be good at instruction following.
Uses the best prompt structure from v6 (single-pass inline CoT + YAML).
...
VERSION = "v9"
DESCRIPTION = "qwen3.5:4b (no thinking) with v6 single-pass CoT + YAML"
PARENT = "v6"
...
def generate(diff: str, *, base_url: str = "http://localhost:11434") -> str:
    """Single-pass CoT + YAML with qwen3.5:4b (no thinking)."""
